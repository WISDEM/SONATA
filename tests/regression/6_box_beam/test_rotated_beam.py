...
class TestBeam(unittest.TestCase):
    ...
    def test_6x6_rotated(self):
        ...
        ref_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), reference_file)

        test_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), test_file)
        ...
        bd_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), bd_file)

        key_points = utils.load_bd_kp(bd_path)

        self.assertEqual(0.0, np.abs(key_points[:, -1]).max()) #"SONATA applied twist, BeamDyn should see 0 twist."
